...
pub enum SkillSource {
    ...
    /// Generated by the evolution engine (DERIVED or CAPTURED).
    /// `parents` holds the parent skill names (empty for CAPTURED).
    Evolution {
        #[serde(default)]
        parents: Vec<String>,
    },
...
"#;
    ...
    fn test_skill_source_serde() {
        ...
        let evo = SkillSource::Evolution {
            parents: vec!["docker".to_string(), "filesystem".to_string()],
        };
